            ...
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    <?php foreach($categories as $cat) { ?>
                        <li><a href="?category=<?php echo $cat; ?>" <?php if(isset($_GET['category']) && $_GET['category'] == $cat) echo 'class="active"'; ?>><?php echo $cat; ?></a></li>
                    <?php } ?>
                </ul>
            </div>
        </div>
    ...
    <div class="row mt-5">
        <div class="col text-center">
            <div class="block-27">
                <ul>
                    <?php if($page > 1) { ?>
                        <li><a href="?category=<?php echo isset($_GET['category']) ? $_GET['category'] : 'All'; ?>&page=<?php echo $page - 1; ?>">&lt;</a></li>
                    <?php } ?>
                    <?php for($i = 1; $i <= $total_pages; $i++) { ?>
                        <li class="<?php if($i == $page) echo 'active'; ?>"><a href="?category=<?php echo isset($_GET['category']) ? $_GET['category'] : 'All'; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                    <?php } ?>
