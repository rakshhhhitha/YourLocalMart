...
if (isset($_POST['add_to_cart'])) {
    ...
    if (isset($_SESSION['cart'])) {
        ...
        if (!in_array($_POST['product_id'], $product_array_ids)) {
            $product_array = array(
                ...
                'product_quantity' => $_POST['product_quantity'] // Changed from 'product_product_quantity'
            );
    ...
    if (isset($_SESSION['cart'])) {
        $removeproduct_id = $_POST['product_id'];
        unset($_SESSION['cart'][$removeproduct_id]);
    ...
    if (isset($_SESSION['cart'])) {
        ...
        // Recalculate total after editing product_quantity
        calculateTotalCart();
    }
} else {
...
<body class="goto-here">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.php">YourLocalMart</a>
                            ...
                            <?php foreach($_SESSION['cart'] as $key => $value) { ?>
                                <tr class="text-center">
                                    ...
                                    <td class="product_quantity">
                                        <form method="POST" action="update_product_quantity.php">
                                            <input type="hidden" name="product_id" value="<?php echo $value['product_id']; ?>">
                                            <input type="number" name="product_quantity" value="<?php echo $value['product_quantity']; ?>" min="1" max="100">
...
<div class="container">
  ...
  <script>
		...
		var quantitiy=0;
		   $('.product_quantity-right-plus').click(function(e){
		     ...
		     $('.product_quantity-left-minus').click(function(e){
		        // Stop acting like a button
		        e.preventDefault();
		        // Get the field name
		        var product_quantity = parseInt($('#product_quantity').val());
