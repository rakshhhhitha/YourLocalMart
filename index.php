...
<html lang="en">
<head>
	<title>YOURLOCALMART - Fresh Clicks, Quick Clicks!</title>
	<meta charset="utf-8">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="index.php" id="dropdown04" data-toggle="dropdown"
							aria-haspopup="true" aria-expanded="false">Shop</a>
						<div class="dropdown-menu" aria-labelledby="dropdown04">
							<a class="dropdown-item" href="index.php">Shop</a>
							<a class="dropdown-item" href="wishlist.html">Wishlist</a>
							<a class="dropdown-item" href="single_product.php">Single Product</a>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-1.jpg);">
						<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="fruits & vegetables.php">Fruits & Vegetables</a></h2>
						</div>
					</div>
					<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(images/category-1.jpg);">
						<div class="text px-3 py-1">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							...
							<div class="bottom-area d-flex px-3">
								<div class="m-auto d-flex"> 
									<a href="<?php echo "single_product.php?product_id=".$row['product_id'];?>" class="buy-now d-flex justify-content-center align-items-center mx-1">
